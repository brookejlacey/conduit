...
- [ ] **Vault detail page** — Click a vault to see deposit history, policy config, yield timeline
- [ ] **Agent detail page** — Click an agent to see decision timeline with expandable AI reasoning
- [ ] **Settlement batch detail** — Click a batch to see entries, FX rates, netting efficiency
